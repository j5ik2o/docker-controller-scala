...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.116"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.116"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.116"
  }
  ...
  object apache {
    ...
    object kafka {
      val kafkaClients = "org.apache.kafka" % "kafka-clients" % "3.0.0"
    }
  }

  object mysql {
    val connectorJava = "mysql" % "mysql-connector-java" % "8.0.27"
  }
  ...
  object elasticsearch {
    val restHighLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.15.2"
  }
  ...
  object twitter {
    val finagleMemcached = "com.twitter" %% "finagle-memcached" % "21.10.0"
  }
