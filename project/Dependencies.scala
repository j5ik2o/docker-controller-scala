...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.795"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.795"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.795"
  }

  object apache {

    object zooKeeper {
      val zooKeeper = "org.apache.zookeeper" % "zookeeper" % "3.9.4"
    }
