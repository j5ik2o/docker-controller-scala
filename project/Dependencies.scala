...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.797"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.797"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.797"
  }

  object apache {

    object zooKeeper {
      val zooKeeper = "org.apache.zookeeper" % "zookeeper" % "3.9.5"
    }

    object kafka {
      val kafkaClients = "org.apache.kafka" % "kafka-clients" % "4.1.1"
    }
  }

  object mysql {
    val connectorJava = "com.mysql" % "mysql-connector-j" % "9.7.0"
  }
  ...
  object elasticsearch {
    val restHighLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.29"
  }
