...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.650"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.650"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.650"
  }
  ...
  object elasticsearch {
    val restHighLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.17"
  }
