...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.300"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.299"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.300"
  }
  ...
  object apache {
    ...
    object kafka {
      val kafkaClients = "org.apache.kafka" % "kafka-clients" % "3.2.2"
    }
  }
  ...
  object elasticsearch {
    val restHighLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.6"
  }
