...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.202"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.199"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.199"
  }
  ...
  object mysql {
    val connectorJava = "mysql" % "mysql-connector-java" % "8.0.28"
  }
  ...
  object elasticsearch {
    val restHighLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.2"
  }
  ...
  object twitter {
    val finagleMemcached = "com.twitter" %% "finagle-memcached" % "22.4.0"
  }
