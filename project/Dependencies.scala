...
object Dependencies {
  ...
  object amazonAws {
    ...
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.576"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.576"
  }
  ...
  object elasticsearch {
    val restHighLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.14"
  }
  ...
  object commons {
    val io = "commons-io" % "commons-io" % "2.14.0"
  }
