...
object Dependencies {
  ...
  object amazonAws {
    ...
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.351"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.352"
  }
  ...
  object elasticsearch {
    val restHighLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.7"
  }
