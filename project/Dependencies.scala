...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.13"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.12.13"
    val sqs      = "com.amazonaws" % "aws-java-sdk-sqs"      % "1.12.13"
  }
