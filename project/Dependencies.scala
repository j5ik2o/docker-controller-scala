...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.11.994"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.11.994"
  }
  ...
  object apache {
    ...
    object kafka {
      val kafkaClients = "org.apache.kafka" % "kafka-clients" % "2.7.0"
    }
  }
